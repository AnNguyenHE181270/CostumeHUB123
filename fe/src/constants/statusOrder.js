import { faCube, faTruck, faClock, faCheckCircle, faCircleXmark } from "@fortawesome/free-solid-svg-icons";
...
export const statusOrder = {
    ...
    returning: { label: "Đang trả", className: "bg-orange-100 text-orange-800 border-orange-200" },
